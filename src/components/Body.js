            ...
            <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                  ...
                  <a
                    href="#"
                    className="font-medium text-lime-600 hover:text-lime-300"
                  >
                    CONNECT WALLET
                  </a>
                </div>
            ...
            >
              ...
              >
                <div className="rounded-lg shadow-md bg-black ring-1 ring-black ring-opacity-5 overflow-hidden">
                  ...
                  <div className="px-2 pt-2 pb-3 space-y-1">
                    {navigation.map((item) => (
                      <a
                        key={item.name}
                        href={item.href}
                        className="block px-3 py-2 rounded-md text-base font-medium text-lime-600"
                      >
                        {item.name}
                      </a>
                    ))}
                  ...
                  <a
                    href="#"
                    className="block w-full px-5 py-3 text-center font-medium text-lime-600 "
                  >
                    CONNECT WALLET
                  </a>
                </div>
